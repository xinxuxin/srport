        ...
        <div className="rounded-[28px] border border-white/55 bg-white/80 p-5 shadow-panel">
          ...
          <div className="mt-5 grid gap-4 lg:grid-cols-[0.9fr_1.2fr_0.9fr]">
            <div className="rounded-[22px] bg-sand p-4">
              ...
              <p className="mt-2 text-sm text-ink/65">Maps RGB pixels into the EPNet feature space.</p>
            </div>
        ...
        <div className="mt-8 grid gap-4 xl:grid-cols-3">
          {explainerCards.map((card, index) => (
            <motion.div
              ...
              className="relative min-w-0 rounded-[24px] border border-ink/8 bg-sand/75 p-5"
            >
              ...
              <div className="min-w-0 pt-4">
                ...
                <p className="mt-1 break-words text-xs uppercase tracking-[0.24em] text-ink/45">
                  {card.subtitle}
                </p>
                <p className="mt-4 break-words text-sm leading-6 text-ink/70">{card.body}</p>
              </div>
            </motion.div>
          ))}
        </div>
