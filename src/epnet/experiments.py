...
def build_default_experiments() -> list[ExperimentSpec]:
    return [
        ExperimentSpec(
            ...
            group="variant",
            variant="edge_tiny",
            description="Smallest edge-oriented preset for parameter efficiency.",
            overrides={},
        ),
        ExperimentSpec(
            name="variant_edge_default",
            group="variant",
            variant="edge_default",
            description="Recommended edge-default preset for local training.",
            overrides={},
        ),
        ExperimentSpec(
            name="variant_paper_like",
            group="variant",
            variant="paper_like",
            description="Paper-like baseline for architectural comparison.",
            overrides={},
        ),
        ExperimentSpec(
            name="variant_balanced_quality",
            group="variant",
            variant="balanced_quality",
            description="Wider preset for quality-oriented local experiments.",
            overrides={},
        ),
        ExperimentSpec(
            name="ablation_pfem2",
